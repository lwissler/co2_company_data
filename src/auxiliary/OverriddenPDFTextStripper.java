 ...
 */
public class OverriddenPDFTextStripper extends OverriddenLegacyPDFStreamEngine
{
     ...
     */
    public OverriddenPDFTextStripper() throws IOException
    {
    }
...
//                }
    ...
    protected void writeString(String text, List<TextPosition> textPositions) throws IOException
    {
    	...
    	for(int i = 2; i < textPositions.size(); i++) {
    		TextPosition tplast = textPositions.get(i);
    		TextPosition tpbefore = textPositions.get(i-1);
    		if(tplast.getYScale()<0.8*tpbefore.getYScale()&&tplast.getY()<tpbefore.getY()) {
    			try {
