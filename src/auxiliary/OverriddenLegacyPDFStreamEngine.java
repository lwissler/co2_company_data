 ...
 */
class OverriddenLegacyPDFStreamEngine extends PDFStreamEngine
{
    private static final Log LOG = LogFactory.getLog(OverriddenLegacyPDFStreamEngine.class);
     ...
     * Constructor.
     */
    OverriddenLegacyPDFStreamEngine() throws IOException
    {
